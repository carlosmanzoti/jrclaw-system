...
export const DEADLINE_TYPE_LABELS: Record<string, string> = {
  ...
  REPLICA: "Réplica",
  IMPUGNACAO_VALOR_CAUSA: "Imp. Valor Causa",
  IMPUGNACAO_JUSTICA_GRATUITA: "Imp. Just. Gratuita",
  IMPUGNACAO_CUMPRIMENTO: "Imp. Cumprimento",
  EXCECAO_PRE_EXECUTIVIDADE: "Exceção Pré-Exec.",
  EMBARGOS_EXECUCAO: "Embargos à Execução",
  EMBARGOS_TERCEIRO: "Embargos de Terceiro",
  EMBARGOS_DECLARACAO: "Embargos de Decl.",
  MANIFESTACAO: "Manifestação",
  ESPECIFICACAO_PROVAS: "Espec. Provas",
  // Recursais
  APELACAO: "Apelação",
  CONTRARRAZOES_APELACAO: "C/R Apelação",
  AGRAVO_INSTRUMENTO: "Agravo de Instrumento",
  CONTRARRAZOES_AGRAVO: "C/R Agravo",
  AGRAVO_INTERNO: "Agravo Interno",
  RECURSO_ORDINARIO: "Recurso Ordinário",
  RECURSO_ESPECIAL: "REsp",
  CONTRARRAZOES_RESP: "C/R REsp",
  RECURSO_EXTRAORDINARIO: "RE",
  CONTRARRAZOES_RE: "C/R RE",
  EMBARGOS_DIVERGENCIA: "Emb. Divergência",
  RECURSO_REVISTA: "Recurso de Revista",
  RECURSO_ORDINARIO_TRABALHISTA: "RO Trabalhista",
  ...
  AUDIENCIA_INSTRUCAO: "AIJ",
  AUDIENCIA_SANEAMENTO: "Aud. Saneamento",
  SUSTENTACAO_ORAL: "Sustentação Oral",
  ASSEMBLEIA_CREDORES: "AGC",
  MEDIACAO: "Mediação",
  DEPOIMENTO_PESSOAL: "Depoimento Pessoal",
  // Recuperação Judicial
  RJ_STAY_PERIOD: "Stay Period",
  RJ_APRESENTACAO_PLANO: "Plano de RJ",
  RJ_OBJECAO_PLANO: "Objeção ao Plano",
  RJ_HABILITACAO_CREDITO: "Hab. Crédito",
  RJ_IMPUGNACAO_CREDITO: "Imp. Crédito",
  RJ_DIVERGENCIA_CREDITO: "Div. Crédito",
  RJ_PRESTACAO_CONTAS_AJ: "Prest. Contas AJ",
  RJ_CUMPRIMENTO_PLANO: "Cumpr. Plano",
  // Execução e Cumprimento
  PAGAMENTO_VOLUNTARIO: "Pgto. Voluntário",
  PENHORA: "Penhora",
  ...
  PROTOCOLO: "Protocolo",
  JUNTADA_DOCUMENTO: "Juntada Doc.",
  JUNTADA_PROCURACAO: "Juntada Procuração",
  SUBSTABELECIMENTO: "Substabelecimento",
  CARGA_AUTOS: "Carga/Vista Autos",
  PERICIA: "Perícia",
  LAUDO_PERICIAL: "Laudo Pericial",
  QUESITOS: "Quesitos",
  CUMPRIMENTO_DECISAO: "Cumpr. Decisão",
  EMENDA_INICIAL: "Emenda à Inicial",
  COMPLEMENTACAO_CUSTAS: "Compl. Custas",
  // Extrajudiciais e Contratuais
  NOTIFICACAO_EXTRAJUDICIAL: "Not. Extrajudicial",
  VENCIMENTO_CONTRATO: "Venc. Contrato",
  PRAZO_REGULATORIO: "Regulatório",
  PRAZO_ADMINISTRATIVO: "Administrativo",
  // Tributários
  IMPUGNACAO_AUTO_INFRACAO: "Imp. Auto Infração",
  RECURSO_ADMINISTRATIVO_FISCAL: "Rec. Fiscal",
